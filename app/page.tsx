...
export default function HomePage() {
  ...
  return (
    <main
      className="min-h-screen bg-[#FAFAFF] overflow-hidden"
      ref={containerRef}
    >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Stop juggling multiple tools. Flux brings your entire workflow
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center items-center gap-12 opacity-40">
              {["Google", "Netflix", "Airbnb", "Spotify", "Uber", "Stripe"].map(
                (company) => (
                  <div
                    key={company}
          ...
          <div className="grid md:grid-cols-5 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-6 max-w-sm">
                The visual workspace where teams create, collaborate, and ship
                faster.
              </p>

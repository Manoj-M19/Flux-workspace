...
export function UserMenu() {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-slate-800 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-purple-100 dark:border-purple-800 overflow-hidden z-50">
        <AnimatePresence>
          {isOpen && (
            <motion.div
